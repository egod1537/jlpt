...
export class GrammarDetail extends PureComponent<GrammarDetailProps> {
  render() {
    const {
      item,
      isFavorite,
    ...
    return (
      <div className="detail-panel">
        ...
        <div className="meta-row">
          <div
            className="meta-chip"
            style={{ borderColor: `${registerColor}33`, color: registerColor }}
          >
            {item.register}
          </div>
          <div className="meta-chip freq-chip">
            {getFrequencyStars(item.frequency)}
          </div>
